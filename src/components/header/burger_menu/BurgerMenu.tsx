...
const BurgerMenu = () => {
    ...
    return (
        <div className="md:hidden flex h-inehrit items-center">
            <button
            ...
            >
                <span
                    className={`block h-[2px] w-full bg-white transition-transform duration-300 ${isOpen ? "rotate-45 translate-y-2.5" : ""
                        }`}
                />
                <span
                    className={`block h-[2px] w-full bg-white transition-opacity duration-300 ${isOpen ? "opacity-0" : "opacity-100"
                        }`}
                />
                <span
                    className={`block h-[2px] w-full bg-white transition-transform duration-300 ${isOpen ? "-rotate-45 -translate-y-2.5" : ""
            ...
            {isOpen && (
                <div className="absolute w-full min-h-full left-0 top-0 bg-blue overflow-y-auto">
