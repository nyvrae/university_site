    ...
    return (
        <section className="history flex-center">
            <div className="history__wrapper wrapper--my">
                ...
                <h2 className="ml-[5px] wwtitle--bold flex flex-col">

                    <span className="text-red text-[56px]">簡史</span>
                    <span>Краткая история</span>
                </h2>

                <div className="mt-[50px] gap-[25px] lg:flex lg:gap-[50px]">
                    <Image className="object-cover lg:w-[50%]" src={students} width={1000} height={1000} alt="" />
