            ...
            <div className="dorm__wrapper wrapper--my">
                ...
                <div className="dorm__content lg:grid lg:grid-cols-2 gap-[50px] mt-[15px]">
                    <div className="content__box flex flex-col gap-[15px]">
                        ...
                        <Link href="https://yandex.by/maps/157/minsk/house/Zk4YcwFkT0UAQFtpfXR4cnxkbQ==/?ll=27.564647%2C53.893044&z=17.5" className="underline underline-offset-4 hover:text-red" target="_blank" rel='noopener noreferrer'>Как добраться?</Link>
                    </div>
